...
```
python evaluate_ate_tum.py PATH_TO_SEQUENCE/groundtruth_quaternions.txt PATH_TO_ORB_OUTPUT/CameraTrajectory_quaternions.txt
```
3.Evaluate rpe (relative pose error) the trajectory generated by our algorithm by executing:
```
python evaluate_rpe_tum.py PATH_TO_SEQUENCE/groundtruth.txt PATH_TO_ORB_OUTPUT/CameraTrajectory_quaternions.txt
```
